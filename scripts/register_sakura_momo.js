...
const contentPath = 'C:\\Users\\mohen\\.gemini\\antigravity-ide\\brain\\1ae1669c-dab1-4f4a-8d0d-f28a5676ffa8\\.system_generated\\steps\\15\\content.md';
...
console.log(`Parsed ${movies.length} Reducing movies for Sakura Momo.`);
...
async function registerAll() {
  ...
  if (actorRes.ok) {
    ...
    if (actors.length > 0) {
      ...
      // Add Sakura Momo details
      const actorBody = {
        name: actorName,
        age: 29,
        height_cm: 160,
        body_size: "B90(G)-W55-H86",
        debut_year: 2017,
        representative_image_url: "https://javtiful.com/uploads/uploads/collections/actresses/2026/04/27/d00ebeefc21033e5cde00e608d0a9e04.jpg",
        image_urls: [
          "https://javtiful.com/uploads/uploads/collections/actresses/2026/04/27/d00ebeefc21033e5cde00e608d0a9e04.jpg"
        ]
      };
  ...
  for (let i = 0; i < movies.length; i++) {
    ...
    let rating_grade = 'A';
    if (i < 3) rating_grade = 'A+';
    else if (i < 8) rating_grade = 'A';
    else rating_grade = 'B+';
    
    const recommendation_score = Math.max(95 - i, 75);
    ...
    const movieData = {
      ...
      actor_id: actorId,
      keywords: ["Sakura Momo", "Idea Pocket", "Reducing", "Featured Actress"],
      rating_grade,
      video_url: movie.video_url,
      description: `Javtiful 개별 영상 페이지 기준으로 등록한 Sakura Momo 작품 (${movie.movie_code}) 입니다.`,
      poster_url: movie.poster_url,
      capture_url: movie.poster_url, // Fallback to poster
      snapshot_url: movie.poster_url, // Fallback to poster
      release_month: releaseMonth,
      production_company: "Idea Pocket",

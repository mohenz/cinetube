...
const contentPath = 'C:\\Users\\mohen\\.gemini\\antigravity-ide\\brain\\1ae1669c-dab1-4f4a-8d0d-f28a5676ffa8\\.system_generated\\steps\\73\\content.md';
...
console.log(`Parsed ${movies.length} Reducing movies for Mashiro Sana.`);
...
async function registerAll() {
  ...
  if (actorRes.ok) {
    ...
    if (actors.length > 0) {
      ...
      // Add Mashiro Sana details
      const actorBody = {
        name: actorName,
        age: 21,
        height_cm: 165,
        body_size: "B93(H)-W57-H86",
        debut_year: 2025,
        representative_image_url: "https://javtiful.com/uploads/uploads/collections/actresses/2026/05/03/8cb1dfa013f0a8b849c18195c7c3be5d.jpg",
        image_urls: [
          "https://javtiful.com/uploads/uploads/collections/actresses/2026/05/03/8cb1dfa013f0a8b849c18195c7c3be5d.jpg"
        ]
      };
  ...
  for (let i = 0; i < movies.length; i++) {
    ...
    const movieData = {
      ...
      actor_id: actorId,
      keywords: ["Mashiro Sana", "MOODYZ", "Reducing", "Featured Actress"],
      rating_grade,
      video_url: movie.video_url,
      description: `Javtiful 개별 영상 페이지 기준으로 등록한 Mashiro Sana 작품 (${movie.movie_code}) 입니다.`,
